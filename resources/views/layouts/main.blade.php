...
<head>
    ...
    <title>UMS</title>
    <link rel="shortcut icon" type="image" href="images/user.png">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    @yield('content')
                    <!-- <h1 style="text-align: center;"> <span style="color: #3490dc ;font-weight:700;">G</span>et <span style="color:#3490dc ; font-weight:700;">S</span>tarted</h1>
                    <img src="/images/user.png" alt="User_logo" style=" display: block;margin-left: auto;margin-right: auto;margin-top:8%"> -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UserXpertbot 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
